...
- 如果修改核心亮度链路，请按 [docs/verification/CORE_FUNCTION_VERIFICATION.md](docs/verification/CORE_FUNCTION_VERIFICATION.md) 记录 lux -> 写入 -> 回读 -> UI 状态，并尽量附上 `scripts/collect-core-verification.ps1 -Interactive` 输出摘要。
